...
data_rows = df.iloc[1:]
X = np.zeros((len(data_rows), 256))
y = []
for i, (_, row) in enumerate(data_rows.iterrows()):
    img_path = os.path.join(r'C:\Users\srik2\Desktop\College\Machine Learning\exp4\english_dataset\Img', row[0])
